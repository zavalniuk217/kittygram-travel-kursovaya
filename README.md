...
Kittygram — это REST API для управления котиками и их достижениями с расширенной функциональностью для планирования совместных путешествий с питомцами. Проект разработан в рамках курсовой работы по дисциплине "Интеграция и управление приложениями на удаленном сервере".
